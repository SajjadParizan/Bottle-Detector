...
ROOT_DIR = os.path.abspath(r"E:\user\danaxa qualification\3-project\github\project file\Mask_RCNN-master")
...
class BottleDataset(utils.Dataset):
    ...
    def load_bottle(self, dataset_dir, subset):
        ...
        with open(os.path.join(dataset_dir,'annotations.json'),'r') as annot:
            annotations = json.loads(annot.read())
